        ...
        palette: {
            ...
            actions: {
                primary: {
                    ...
                    textPressed: customTheme.mappedColors.action.primary.textPressed(mode),
                    textDisabled: customTheme.mappedColors.action.primary.textDisabled(mode),
                    textFocused: customTheme.mappedColors.action.primary.textFocused(mode)
                },
                secondary: {
                    ...
                    textPressed: customTheme.mappedColors.action.secondary.textPressed(mode),
                    textDisabled: customTheme.mappedColors.action.secondary.textDisabled(mode),
                    textFocused: customTheme.mappedColors.action.secondary.textFocused(mode)
                },
                info: {
                ...
                warning: {
                    ...
                    textPressed: customTheme.mappedColors.action.warning.textPressed(mode),
                    textDisabled: customTheme.mappedColors.action.warning.textDisabled(mode),
                    textFocused: customTheme.mappedColors.action.warning.textFocused(mode)
                },
                error: {
                    ...
                    textDisabled: customTheme.mappedColors.action.error.textDisabled(mode),
                ...
                success: {
                    ...
                    textPressed: customTheme.mappedColors.action.success.textPressed(mode),
                    textDisabled: customTheme.mappedColors.action.success.textDisabled(mode),
                    textFocused: customTheme.mappedColors.action.success.textFocused(mode)
                }
            }
        },
        typography: {
        ...
        components: {
            ...
            MuiOutlinedInput: {
                styleOverrides: {
                    root: {
                        '&.Mui-focused': {
                            borderColor: customTheme.mappedColors.action.primary.disabled(mode),
                    ...
                    },
                    {
                        ...
                        style: {
                            ...
                            '&:focus': {
                                ...
                                color: customTheme.mappedColors.action.warning.textFocused(mode)
                            },
                            '&:active': {
                                backgroundColor:
                                    customTheme.mappedColors.action.warning.pressed(mode),
                    ...
                    },
                    {
                        ...
                        style: {
                            ...
                            '&:focus': {
                                ...
                                color: customTheme.mappedColors.action.success.textFocused(mode)
                            },
                            '&:active': {
                                backgroundColor:
                                    customTheme.mappedColors.action.success.pressed(mode),
                    ...
                    },
                    {
                        ...
                        style: {
                            ...
                            '&:active': {
                                backgroundColor: customTheme.mappedColors.surface.warning(mode),
                                color: customTheme.mappedColors.action.warning.pressed(mode),
                                borderColor: customTheme.mappedColors.action.warning.pressed(mode)
                            },
                            '&:disabled': {
                                backgroundColor: customTheme.mappedColors.surface.warning(mode),
                                borderColor: customTheme.mappedColors.action.warning.disabled(mode),
                                color: customTheme.mappedColors.action.warning.disabled(mode)
                            }
                        }
                    },
                    ...
                    },
                    {
                        ...
                        style: {
                            ...
                            '&:active': {
                                backgroundColor: customTheme.mappedColors.surface.success(mode),
                                color: customTheme.mappedColors.action.success.pressed(mode),
                                borderColor: customTheme.mappedColors.action.success.pressed(mode)
                            },
                            '&:disabled': {
                                backgroundColor: customTheme.mappedColors.surface.success(mode),
                                borderColor: customTheme.mappedColors.action.success.disabled(mode),
                                color: customTheme.mappedColors.action.success.disabled(mode)
                            }
                        }
                    }
